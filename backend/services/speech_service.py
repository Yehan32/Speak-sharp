...
Main orchestrator for all speech analysis operations
"""
...
class SpeechAnalysisService:
    """
    Main service for comprehensive speech analysis
    ...
    async def analyze(
        ...
        try:
            ...
            logger.info("⏱️  Step 3/8: Evaluating proficiency...")
            ...
            logger.info("🏗️  Step 6/8: Analyzing speech structure...")
            ...
            if analysis_depth in ["standard", "advanced"]:
                logger.info("🗣️  Step 7/8: Analyzing pronunciation...")
